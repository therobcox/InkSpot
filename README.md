...
# Description
A simple monochrome Dynamic Wallpaper theme for gnome desktop. The spots change color every 15 seconds creating a subtle and pleasant background.

Included are two background themes. InkSpot-LowDef is a lower pixel rate (72 ppi), producinging oldschool graphics vibe. InkSpot-HighDef is made using high pixel rate (300 ppi).

The Dynamic Wallpapers can be installed directly into the system backgrounds folder, allowing you to enable using the gnome Settings -> Backgrounds section of your distribution. 
